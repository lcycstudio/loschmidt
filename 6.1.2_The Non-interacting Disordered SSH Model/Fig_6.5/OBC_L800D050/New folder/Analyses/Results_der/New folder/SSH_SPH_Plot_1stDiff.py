...
fig = plt.figure()
ax = plt.subplot(111)
Wlabel=['0.0','5e-8','5e-7','5e-6','5e-5','1e-4','5e-4','1e-3','5e-3']
...
fig = plt.figure()
ax = plt.subplot(111)
ax.plot(tm0,Pfiles[0],label='W='+Wlabel[0])
...
fig = plt.figure()
ax = plt.subplot(111)
ax.plot(tm0,dy[0],label='W='+Wlabel[0])
for num in range(1,len(Pfiles)):
    if num < 8:
...
ax = plt.subplot(111)
ax.plot(tm0[1200:1360],dy[0][1200:1360],label='W='+Wlabel[0])
for num in range(1,len(Pfiles)):
    if num < 8:

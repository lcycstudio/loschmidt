...
"""Plot the Figure """
wb=['1e-4','1e-3','0.01','0.06','0.1','1.0','3.5','6.0']
...
for i in range(2000):
    if top==Qfiles[0][i]:
        tc=tm[i]
plt.axvline(tc,-0.1,top/0.8,linestyle=':')
...
ip = InsetPosition(ax2, [0.15, 0.03, 0.45, 0.45]) #posx, posy, width, height
iax.set_axes_locator(ip)
plt.plot(tm[780:820],dyy[780:820])
for num in range(len(Pfiles)):
    plt.plot(tm[780:820],dy[num][780:820])#,'--',label='W='+wb[num])
plt.yticks([])
plt.xticks([])

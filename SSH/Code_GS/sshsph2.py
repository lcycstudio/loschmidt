...
parser.add_argument('-dt2', type=float, default=0.001,
                    help='# discrete time interval second part')
parser.add_argument('-dt3', type=float, default=0.1,
                    help='# discrete time interval second part')
parser.add_argument('-tint', type=float, default=5,
                    help='# maximum time range first part')
parser.add_argument('-tmid1', type=float, default=6.5,
                    help='# maximum time range first part')
parser.add_argument('-tmid2', type=float, default=8,
                    help='# maximum time range first part')
parser.add_argument('-tmax', type=float, default=9,
                    help='# maximum time range second part')
parser.add_argument('-dat', type=int, default=40,
                    help='# data size')

...
for num in range(len(Pfiles)):
    if num <5:
        if num == 0:
            ax.plot(tm0[1200:1320],dy[num][1200:1320],label='W='+Wlabel[num])
        else:
            ax.plot(tm[1200:1320],dy[num][1200:1320],label='W='+Wlabel[num])
    elif num > 9:
        ax.plot(tm[1200:1320],dy[num][1200:1320],':',label=item[num][19:-4])
    else:
        ax.plot(tm[1200:1320],dy[num][1200:1320],label=item[num][19:-4])
plt.xlabel('Time t')
plt.ylabel('1st Derivative dl/dt')

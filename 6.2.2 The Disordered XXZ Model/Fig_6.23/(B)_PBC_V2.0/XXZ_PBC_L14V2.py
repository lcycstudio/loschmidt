...
ip = InsetPosition(ax2, [0.02, 0.02, 0.45, 0.45]) #posx, posy, width, height
iax.set_axes_locator(ip)
plt.plot(tm[4850:4900],dyy[4850:4900])
for num in range(len(Pfiles)):
    plt.plot(tm[4850:4900],dy[num][4850:4900])#,'--',label='W='+wb[num])
plt.yticks([])
plt.xticks([])
plt.show()

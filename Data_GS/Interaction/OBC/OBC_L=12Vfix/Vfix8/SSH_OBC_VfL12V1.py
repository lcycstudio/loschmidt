...
ip = InsetPosition(ax1, [0.02, 0.02, 0.4, 0.4]) #posx, posy, width, height
iax.set_axes_locator(ip)
plt.plot(tm[100:600],dy2[0][100:600],label='W=0.0')
for num in range(len(Pfiles)):
    plt.plot(tm[100:600],dy[num][100:600],label='W='+wb[num])
plt.yticks([])
plt.xticks([])
plt.show()
